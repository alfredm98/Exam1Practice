...
def run_test_problem3a():
    ...
    # Window 4:
    title = 'Problem 3a. Test 5: Start at (45, 45), 10 lines'
    window4 = rg.RoseWindow(450, 300, title)

    # Test 5 (it is on window 3):
    point = rg.Point(45, 45)
    expected = 88
...
def problem3a(window, point, n):
    ...
    total = 0
    for k in range(n):
        start = rg.Point(point.x + k*20, point.y + k*10)
...
def problem3b(m, point1):
    ...
    count = 3
    for k in range(m):
        answer = problem3a(window, point1, count)
        total = total + answer
